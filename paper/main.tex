...
\hypersetup{
  ...
  citecolor=deepgreen,
  urlcolor=deepred,
  pdftitle={Synthetic Data in the Age of Scaling - English Edition},
...
\date{Version 1.0.1 -- English edition -- 15 June 2026}
...
\input{sections/02_source_audience}
\input{sections/03_twelve_year_old}
\input{sections/04_engineer}
\input{sections/05_phd}
\input{sections/06_julia_environment}
\input{sections/07_mmalsa_orientation}
\input{sections/08_stratq_governance}
\input{sections/09_companion_studies}
\input{sections/10_experimental_program}
\input{sections/11_conclusion}
\appendix
\input{sections/A_notation}
\input{sections/B_claim_matrix}
